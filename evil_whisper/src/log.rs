...
macro_rules! trace {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Trace, format!($($arg)*));
    }};
}
...
macro_rules! info {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Info, format!($($arg)*));
    }};
}
...
macro_rules! warn {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Warn, format!($($arg)*));
    }};
}
...
macro_rules! error {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Error, format!($($arg)*));
    }};
}
...
macro_rules! debug {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Debug, format!($($arg)*));
    }};
}
...
macro_rules! success {
    ($($arg:tt)*) => {{
        $crate::log::_log(crate::log::Level::Success, format!($($arg)*));
    }};
}
